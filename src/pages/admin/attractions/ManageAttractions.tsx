...
const convertAttraction = (attr: RawAttraction): AttractionRow => ({
  ...
  maxTicketsPerSlot: attr.max_tickets_per_slot ?? null,
  ...
  const handleImport = async () => {
    try {
      ...
      const attractionsToImport = parsedData.map((attraction: AttractionRow) => ({
        ...
        max_tickets_per_slot: attraction.maxTicketsPerSlot ?? (attraction as { max_tickets_per_slot?: number | null }).max_tickets_per_slot ?? null,
