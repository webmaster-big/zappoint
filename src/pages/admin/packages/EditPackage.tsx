    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const updateData = {
                ...
                partial_payment_percentage: form.partialPaymentPercentage.trim() === "" ? null : parseInt(form.partialPaymentPercentage),
                partial_payment_fixed: form.partialPaymentFixed.trim() === "" ? null : Number(form.partialPaymentFixed),
                has_guest_of_honor: form.hasGuestOfHonor,
                customer_notes: form.customerNotes.trim(),
                invitation_download_link: form.invitationType === 'link' ? form.invitation_download_link.trim() : null,
                invitation_file: form.invitationType === 'file' ? (form.invitation_file || null) : null,
